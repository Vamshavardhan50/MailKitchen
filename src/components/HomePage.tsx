    ...
    <div className="bg-[#f5f0e8] text-[#1a1a1a]">
      ...
      <section id="menu" className="bg-[#1e382f] text-white py-24 px-8 md:px-16 lg:px-24">
        <div className="max-w-[1320px] mx-auto">
          <div className="mb-14">
            ...
            <p className="text-white/70 text-[15px] max-w-[620px]">
      ...
      <section className="bg-[#f5f0e8] py-24 px-8 md:px-16 lg:px-24">
        <div className="max-w-[1320px] mx-auto text-center">
          ...
          <h2 className="text-[40px] md:text-[56px] font-black text-[#1e382f] mb-14">
                  ...
                  return (
                    ...
                    >
                      <div>
                        ...
                        <h3 className="font-bold text-[19px] mb-4 leading-snug text-white">{stepTitle}</h3>
      ...
      {/* ═══════════════════════════════════════════════
          7. EXPERIENCE
      ═══════════════════════════════════════════════ */}
      <section className="bg-white py-20 md:py-28 px-8 sm:px-12 md:px-20 lg:px-28">
        <div className="max-w-[1360px] mx-auto">
          ...
          <div className="text-center max-w-[800px] mx-auto mb-12 md:mb-16">
            ...
            <h2 className="text-[34px] sm:text-[42px] md:text-[48px] font-black text-[#1e382f] leading-tight mb-4">
      ...
      ═══════════════════════════════════════════════ */}
      <section id="catering" className="bg-[#f5f0e8] py-24 px-8 md:px-16 lg:px-24 border-t border-[#ebdcd0]/60">
        <div className="max-w-[1360px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col justify-center space-y-6">
              <div>
                <span className="bg-[#d85c27] text-white text-[11px] font-black tracking-[0.18em] px-4 py-1.5 rounded-full uppercase shadow-sm inline-block mb-4">
                  {(isDe ? content.cateringBadgeDe : content.cateringBadgeEn) || 'MAATI CATERING'}
                </span>
                <h2 className="text-[34px] sm:text-[44px] md:text-[50px] font-black text-[#1e382f] leading-[1.1] mb-6">
                  {(isDe ? content.cateringTitleDe : content.cateringTitleEn) || 'Bold Flavours That Fuel Your Team'}
                </h2>
              </div>

              <div className="space-y-4 text-[#555] text-[15px] md:text-[16px] leading-relaxed">
                <p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <div className="flex items-center gap-2.5 text-[#1e382f] font-extrabold text-[14px]">
            ...
            <div className="lg:col-span-5">
              <div className="group rounded-[36px] overflow-hidden shadow-2xl bg-[#ebdcd0]/40 border border-[#ebdcd0] transition-transform duration-500 hover:scale-[1.02]">
                <img
                  src={content.cateringImage || "/assets/show3-D0blnzja.jpeg"}
                  alt="MAATI Fresh Catering Spread"
                  loading="lazy"
                  className="w-full h-[420px] md:h-[480px] object-cover group-hover:scale-105 transition-transform duration-700 ease-out"
                />
              </div>
            </div>
      ...
      ═══════════════════════════════════════════════ */}
      <section className="bg-[#1e382f] text-white py-20 px-8 md:px-16 lg:px-24 text-center">
        <div className="max-w-[800px] mx-auto">
          <h2 className="text-[36px] md:text-[48px] font-black leading-tight mb-4">
          ...
          <p className="text-white/70 text-[16px] md:text-[17px] mb-8 max-w-[500px] mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <Link
              to="/locations"
              className="border-2 border-white/40 hover:border-white text-white font-extrabold px-8 py-3.5 rounded-full text-[15px] transition-all duration-300 hover:bg-white/10"
            >
